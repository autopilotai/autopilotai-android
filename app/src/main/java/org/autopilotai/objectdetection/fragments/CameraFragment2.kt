...
import org.autopilotai.objectdetection.KEY_EVENT_ACTION
import org.autopilotai.objectdetection.KEY_EVENT_EXTRA
import org.autopilotai.objectdetection.R
import org.autopilotai.objectdetection.databinding.CameraUiContainerBinding
import org.autopilotai.objectdetection.databinding.FragmentCamera2Binding
import org.autopilotai.objectdetection.utils.ANIMATION_FAST_MILLIS
import org.autopilotai.objectdetection.utils.ANIMATION_SLOW_MILLIS
import org.autopilotai.objectdetection.utils.MediaStoreUtils
import org.autopilotai.objectdetection.utils.simulateClick
    ...
    override fun onResume() {
        ...
        if (!PermissionsFragment.hasPermissions(requireContext())) {
            Navigation.findNavController(requireActivity(), R.id.fragment_container).navigate(
                    CameraFragment2Directions.actionCameraToPermissions()
            )
        }
    }
        ...
        cameraUiContainerBinding?.photoViewButton?.setOnClickListener {
            ...
            lifecycleScope.launch {
                if (mediaStoreUtils.getImages().isNotEmpty()) {
                    findNavController().navigate(CameraFragment2Directions.actionCameraToGallery(
